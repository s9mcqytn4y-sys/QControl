...
import id.primaraya.qcontrol.data.repositori.RepositoriInputHarianLokal
import id.primaraya.qcontrol.data.repositori.RepositoriMasterDataLokal
...
class KelolaInputHarianUseCase(
    ...
    suspend fun ambilAtauBuatDraft(tanggalProduksi: String, lineId: String): HasilOperasi<DraftPemeriksaanHarian> {
        return repositoriInputHarianLokal.ambilAtauBuatDraft(tanggalProduksi, lineId)
    }

    suspend fun bacaDaftarPart(pemeriksaanHarianId: String, lineId: String, kataKunci: String = ""): HasilOperasi<List<DraftInputPart>> {
    ...
    suspend fun bacaDaftarProduksiTanpaNg(pemeriksaanHarianId: String): HasilOperasi<List<DraftProduksiTanpaNg>> {
        return repositoriInputHarianLokal.ambilDraftProduksiTanpaNg(pemeriksaanHarianId)
    }

    suspend fun bacaDaftarDefectSlot(inputPartId: String): HasilOperasi<List<DraftInputDefectSlot>> {
    ...
    suspend fun hitungRingkasan(pemeriksaanHarianId: String): HasilOperasi<RingkasanInputHarian> {
        return repositoriInputHarianLokal.hitungRingkasan(pemeriksaanHarianId)
    }
    
    suspend fun resetDraft(pemeriksaanHarianId: String): HasilOperasi<Unit> {
